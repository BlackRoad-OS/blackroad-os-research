...
> **The official lab notebook + library for BlackRoad OS** 📚🧬

This index collects the core theory, specifications, and experiments that form the research substrate for BlackRoad OS. Use it to navigate foundational SIG geometry, PS-SHA∞ identity mechanics, agent theory, Amundson equations, Lucidia orchestration theory, and supporting audits or simulations.

---

## 🧬 Quick Navigation

| 🌀 SIG | 🔐 PS-SHA∞ | 🤖 Agents | 🧬 Amundson | 🧠 Lucidia |
|--------|-----------|-----------|-------------|-----------|
| [Overview](sig/sig-overview.md) | [Definition](ps-sha-infinity/definition.md) | [Overview](agents/README.md) | [Foundations](amundson-equations/foundations.md) | [Architecture](lucidia/architecture.md) |
...
### Agent Theory 🤖
- [Agents Overview](agents/README.md): theories of agent identity, behavior, and orchestration
- [Agent Identity](agents/agent-identity.md): how PS-SHA∞ anchors agent identity 🔐
- [Agent Behavior](agents/agent-behavior.md): cognitive models, beliefs, and decision architectures 🧠
- [Agent Orchestration](agents/agent-orchestration.md): multi-agent coordination and task routing 🎼

### Amundson Equations 🧬
- [Foundations](amundson-equations/foundations.md): core axioms for unified math/physics/AI framework
- [Spiral Dynamics](amundson-equations/spiral-dynamics.md): equations of motion on SIG manifolds 🌀
- [Identity Conservation](amundson-equations/identity-conservation.md): conservation laws for PS-SHA∞ worldlines 🔐
...
- [Symbols](glossary/symbols.md): symbol table for recurrent notation + emoji legend 🧬
...
If a new dev/agent wants to turn BlackRoad math into code, this index should help answer:
