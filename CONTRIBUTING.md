# Contributing to blackroad-os-research
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-os-research.git
cd blackroad-os-research

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-os-research.git
